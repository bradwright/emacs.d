...
*FIXME*: this won't work if I open multiple Go buffers from different =gom=
projects - the =GOPATH= will clash. [[http://stackoverflow.com/questions/16786831/how-can-i-set-environment-variables-to-a-buffer-local-scope-in-emacs][Potential fix]].
