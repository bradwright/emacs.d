...
#+begin_src emacs-lisp
  (add-to-list 'package-pinned-packages '(projectile . "melpa"))
...
#+begin_src emacs-lisp
  (add-to-list 'package-pinned-packages '(solarized-theme . "melpa"))
#+end_src
...
#+begin_src emacs-lisp
  (add-to-list 'package-pinned-packages '(go-mode . "melpa"))
...
Install [[swiper]] from latest code:
...
Pin a more modern version than the 2015 version that comes with Emacs:

#+begin_src emacs-lisp
  (add-to-list 'package-pinned-packages '(php-mode . "melpa"))
#+end_src
