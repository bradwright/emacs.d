...
Ensure that the [[https://github.com/bbatsov/solarized-emacs#underline-position-setting-for-x][descender in the modeline]] doesn't sit up against the buffer name
(this only comes into play if =solarized-high-contrast-mode-line= isn't set):
